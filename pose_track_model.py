...
def train_pose_tracking() :
    print ("\nPose Tracking Model - Keypoints pre-processing ")
    ...
    data = []
    print('Pose Tracking Model : Loading pose data..')
    ...
    df = pd.DataFrame(data)    
    print('Pose Tracking Model : Loading pose data completed..')
    ...
    print('Pose Tracking Model : Preparing data for training..')
    ...
    print('Pose Tracking Model : SVC Training started..')
    svc_model = SVC(kernel = 'linear', C = 10).fit(X_train, y_train)
    print('Pose Tracking Model : SVC Model training completed..')
    ...
    print("========================Pose Tracking Model Metrics ======================================================\n")
