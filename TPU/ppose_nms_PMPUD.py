...
def write_json(all_results, outputpath, form=None, for_eval=False,
               lbl_name='not_categorized', input_file_name=None,
               output_file_name='alphapose-results.json'):
    '''
    ...
    for im_res in all_results:
        ...
        for human in im_res['result']:
            ...
            result['category_id'] = lbl_name
            result['file_name'] = input_file_name
    ...
    if form == 'cmu': # the form of CMU-Pose
        with open(os.path.join(outputpath, output_file_name), 'w') as json_file:
